...
check_out_book = 'THE POWER OF MOMENTS'
check_out(check_out_book)
...
check_in_book = 'THE POWER OF MOMENTS'
check_in(check_in_book)
...
search_book = 'JUST MERCY'
search_by_name(search_book)

# 1.11 TODO: Search for the book '4000 WEEKS'
search_book = '4000 WEEKS'
search_by_name(search_book)
...
#the list is structured as a dictionary, with the keys being title, author and description.
